...
// let Array3 = prompt("Add a Fruits, Mobiles, Bikes, Cars and Birds Name :");
// let Array8 = Array2.filter((Array) => Array2.length);
// console.log(Array8);
  ...
  // const input = prompt("Enter The Fruit, Mobile, Bike, Car, Bird Name");
  
  // if(input === "Fruits"){
  //   console.log("Fruits",Array2[0]["Fruits"]);
  // }

  // else if(input === "Mobiles"){
  //   console.log("Mobiles",Array2[0]["Mobiles"]);
  // }

  // else if(input === "Bikes"){
  //   console.log("Bikes",Array2[0]["Bikes"]);
  // }

  // else if(input === "Cars"){
  //   console.log("Cars:",Array2[0]["Cars"]);
  // }

  // else if(input === "Birds"){
  //   console.log("Birds:" ,Array2[0]["Birds"]);
  // }

  // else{
  //   console.log("Please! Enter The Right Value For Result.");
  // }
...
// Array4 = ["4", "21", "32", "56", "23", "14", "38", "78"];
// Array5 = Array4.filter((word)  => word < 50);
// Array6 = Array4.filter((word)  => word > 50);
// console.log(Array5);
// console.log(Array6);
