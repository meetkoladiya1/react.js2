...
{
  let msec = Date.parse("august 25, 2006");
  console.log(msec);   // 1707417000000 - 1156444200000 = 5,50,97,28,00,000
}
...
let Date22 = Date21.setDate(10);
console.log(Date21);

let Date23 = Date21.setFullYear(2023);
console.log(Date21);

let Date24 = Date21.setHours(30);
console.log(Date21);

let Date25 = Date21.setMilliseconds(3000);
console.log(Date21);

let Date26 = Date21.setMinutes(30);
console.log(Date21);

let Date27 = Date21.setMonth(10);
console.log(Date21);

let Date28 = Date21.setSeconds(45);
console.log(Date21);
  
let Date29 = Date21.setTime(2000);
console.log(Date21);

let Date30 = Date21.setUTCDate(0);
console.log(Date21);
