...
{
    const regex1 = /K+o+l+a+d+i+y+a+ +M+i+t+ +2+5+-+0+8+-+2+0+0+6/
    console.log(regex1.test('Koladiya Mit 25-08-2006'));
}
{
    const regex2 = /^Ko....*ya\sM.t\s25*\s08+\s2..6$/
    console.log(regex2.test('Koladiya Mit 25 08 2006'))
}
{
    const regex3 = /^K......a+ +M.t+ +2........6/
    console.log(regex3.test('Koladiya Mit 25 08 2006'))
}
...

{
    ...
    console.log(Regex.test('meetkoladiya0171@gmail.com'));
    


    const regex = /(\d{2})\D(\d{2})\D(\d{2})\D(\d{2})\D(\d{2})/g;
    const result = regex.exec('Phone Number 12 12 12 12 12');
    console.log(result);

    const regex1 = /(\d{3})\D(\d{3})\D(\d{2})\D(\d{2})/g;
    const result1 = regex1.exec('Phone Number 121 212 12 12');
    console.log(result1);

    const regex2 = /(\d{4})\D(\d{4})\D(\d{2})/g;
    const result2 = regex2.exec('Phone Number 1212 1212 12');
    console.log(result2);



    const regex3 = /(\d{2})-(\d{2})-(\d{2})-(\d{2})-(\d{2})/g;
    const result3 = regex3.exec('Phone Number 12-12-12-12-12');
    console.log(result3);

    const regex4 = /(\d{3})-(\d{3})-(\d{2})-(\d{2})/g;
    const result4 = regex4.exec('Phone Number 121-212-12-12');
    console.log(result4);

    const regex5 = /(\d{4})-(\d{4})-(\d{2})/g;
    const result5 = regex5.exec('Phone Number 1212-1212-12');
    console.log(result5);
}